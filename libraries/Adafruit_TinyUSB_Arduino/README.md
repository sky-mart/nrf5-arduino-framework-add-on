# Adafruit TinyUSB Library for Arduino addon
...
# Add-on
This is just addon to orignal [Adafruit TinyUSB Arduino](https://github.com/adafruit/Adafruit_TinyUSB_Arduino), which solves problem on nRF5 devices with disabling HF external clock, when SoftDevice is not used and USB is removed.
